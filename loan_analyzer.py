...
average=total_of_all_loans/total_of_all_loans
print(average)
...
Extract = {'Future Value':1000, 'Remaining months':9}
print(Extract.get('Future Value'))
print(Extract.get('Remaining months'))
...
present_value = 1000/(1+0.2/100)*12
print(present_value)
